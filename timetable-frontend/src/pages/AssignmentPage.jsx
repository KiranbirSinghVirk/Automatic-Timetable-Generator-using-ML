...
function AssignmentPage() {
  ...
  return (
    <div className="container mx-auto py-16 px-4 bg-gradient-to-b from-red-50 to-white min-h-screen">
      {/* Header with animation */}
      <motion.h1
        className="text-4xl md:text-5xl font-extrabold text-gray-900 mb-4 text-center bg-clip-text text-transparent bg-gradient-to-r from-red-600 to-orange-600"
      ...
      <motion.p
        ...
        animate="visible"
      >
        Assign faculty to subjects and branches for your timetable system with ease and accuracy.
      </motion.p>

      {/* FacultyAssignment Component */}
      <motion.div
